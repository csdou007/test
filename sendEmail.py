...
#    print mail_body
    ...
    #发送邮箱用户名/密码
    user = 'chengsendou1'#发送邮箱的用户名
    password='d7780044'#授权码的密码
    #发送邮箱
    sender='chengsendou1@126.com'
    #多个接收邮箱，单个收件人的话，直接是receiver='XXX@126.com'
    #receiver='dcs_007@126.com'
    receiver=['dcs_007@126.com','372766375@qq.com']
    #receiver=['XXX@126.com','XXX@126.com','XXX@doov.com.cn']
    #发送邮件主题
    subject = u'自动定时发送测试报告'
...
#要在163有限设置授权码（即客户端的密码），否则会报535
    #msg['From'] = 'dcs_007@126.com'
    msg['From'] = 'chengsendou1@126.com <chengsendou1@126.com>'
...
#不用绝对路径会报：ImportError: Start directory is not importable: './test_case'
    test_dir = 'E:\\jiekou\\testcases\\'
    #知道测试报告的路径
    test_report_dir='E:\\jiekou\\report\\'
